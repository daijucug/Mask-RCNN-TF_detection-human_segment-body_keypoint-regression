...
tf.app.flags.DEFINE_string(
    'train_dir', '/hdd1/Alex/testMaskRCNN_human_bodyparts_keypoints/MaskRCNN_body/output/mask_rcnn',
    'Directory where checkpoints and event logs are written to.')

tf.app.flags.DEFINE_string(
    'pretrained_model', '/hdd1/Alex/testMaskRCNN_human_bodyparts_keypoints/MaskRCNN_body/data/pretrained_models/resnet_v1_50.ckpt',
...
tf.app.flags.DEFINE_string(
    'dataset_dir', '/hdd1/Alex/testMaskRCNN_human_bodyparts_keypoints/MaskRCNN_body/data/coco',
...
tf.app.flags.DEFINE_float('learning_rate', 0.00002,#0.00002
