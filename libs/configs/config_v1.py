...
tf.app.flags.DEFINE_string(
    'train_dir', '/hdd1/Alex/Human-Body-Part-Detector/FastMaskRCNN/output/mask_rcnn/',
    'Directory where checkpoints and event logs are written to.')

tf.app.flags.DEFINE_string(
    'pretrained_model', '/hdd1/Alex/Human-Body-Part-Detector/FastMaskRCNN/data/pretrained_models/resnet_v1_50.ckpt',
...
tf.app.flags.DEFINE_string(
    'dataset_dir', '/hdd1/Alex/Human-Body-Part-Detector/FastMaskRCNN/data/coco/',
