...
def sample_rpn_outputs(boxes, scores, is_training=False, only_positive=False):
  ...
  # testing: 6000, 400
  if not is_training:
    pre_nms_top_n = int(pre_nms_top_n / 70)
    post_nms_top_n = int(post_nms_top_n / 70)
  ...
  #print ("NMSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSs",pre_nms_top_n,post_nms_top_n,is_training)
