...
options = tf.python_io.TFRecordOptions(TFRecordCompressionType.ZLIB)
#for record in tf.python_io.tf_record_iterator('data/coco/out_human_and_keypoints_to_body_parts_COCO_3.tfrecord',options):
...
#for record in tf.python_io.tf_record_iterator('data/jhmdb/out_human_and_body_parts_JHMDB.tfrecord',options):
